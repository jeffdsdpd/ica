	...
	Highcharts
			.chart(
					'container',
					{
						...
						title : {
							text : 'Phase percentages based on teachers in '
									+ schoolName
						},
						tooltip : {
						...
						series : [ {
							...
							data : [ {
								name : 'Phase 1',
								y : parseInt('${phaseValues[0].phase1}')
							}, {
								name : 'Phase 2',
								y : parseInt('${phaseValues[0].phase2}')
							}, {
								name : 'Phase 3',
								y : parseInt('${phaseValues[0].phase3}')
							} ]
						} ]
					});
});
